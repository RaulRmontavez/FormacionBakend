...
public class Persona {
    ...
    public Persona(PersonaInputDto persona) {
        System.out.println(persona.getPersonal_email());
    ...
    public PersonaOutputDto personaToPersonaOutputDto() {
        ...
        return new PersonaOutputDto(this.id_persona, this.usuario, this.password, this.name, this.surname, this.company_email,this.personal_email, this.city, this.active,
